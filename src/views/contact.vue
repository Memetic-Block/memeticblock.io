  ...
  <div class="py-8">
    ...
    <section class="max-w-2xl mx-auto">
      <iframe
        ...
        class="w-full"
        style="height: 556px;"
        @load="onContactFormLoaded"
      ></iframe>
      <p v-show="showLoadingMessage" class="text-center text-gray-text">
...
const showLoadingMessage = ref<boolean>(true)
const onContactFormLoaded = () => {
